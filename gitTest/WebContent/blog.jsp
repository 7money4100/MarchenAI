    ...
    <div class="nav1-wrap">
      ...
      <div id="w-node-_8bdc9590-22a2-e972-4daa-ca5062e76209-62e76204" class="nav1-menu-wrap">
        <nav role="navigation" class="nav1-menu w-nav-menu">
          ...
          <a href="blog.jsp" aria-current="page" class="nav-link w-nav-link w--current">Blog</a>
      ...
      <div class="w-dyn-list">
        <div role="list" class="w-dyn-items">
          <div role="listitem" class="w-dyn-item">
            <div class="w-layout-grid hero3">
              <div id="w-node-dfe7ef0c-dec5-0066-7949-dd1171469d5a-3f3fd67e" class="hero3-content">
                <div class="label">Featured Post</div>
                <a href="#" class="size1-link"></a>
                <p class="paragraph-70"></p>
              </div>
              <div id="w-node-dfe7ef0c-dec5-0066-7949-dd1171469d61-3f3fd67e" class="hero3-image"></div>
              <a id="w-node-dfe7ef0c-dec5-0066-7949-dd1171469d62-3f3fd67e" data-w-id="dfe7ef0c-dec5-0066-7949-dd1171469d62" href="#" class="button-large hero2-button w-inline-block">
                <div>Read the full story</div><img src="images/Arrow2x.svg" alt="" class="button-arrow">
              </a>
            </div>
          </div>
        </div>
  ...
  <div class="wrapper m0-100">
    <div class="section">
      <div class="w-layout-grid blog1-grid">
        <div id="w-node-_90fef650-dc97-e834-4936-37bb9ed37933-3f3fd67e" class="blog1-headline-wrap">
          <div class="text-label">OUR ARTICLES</div>
          <div class="size3-text">Genius Blog Posts<br></div>
        </div>
        <div id="w-node-_4d28ad15-467b-7f94-196f-4975ea0b9d93-3f3fd67e" class="blog1-headline-wrap">
          <div class="text-label">Explore more</div>
          <div class="size3-text">Navigation<br></div>
        </div>
        <div id="w-node-_90fef650-dc97-e834-4936-37bb9ed37939-3f3fd67e" class="w-dyn-list">
          <div role="list" class="blog1-grid w-dyn-items">
            <div id="w-node-_90fef650-dc97-e834-4936-37bb9ed3793b-3f3fd67e" role="listitem" class="collection-item w-dyn-item">
              <div>
                <div class="blog1-image-wrap">
                  <div class="label inside-label">News</div>
                  <a href="#" class="blog1-image w-inline-block"></a>
                </div>
                <a href="#" class="size4-link"></a>
                <p class="text-label"></p>
                <div class="paragraph-70"></div>
                <div class="blog1-button-wrap">
                  <a data-w-id="90fef650-dc97-e834-4936-37bb9ed37945" href="#" class="button-small w-inline-block">
                    <div class="button-label">Read more</div><img src="images/Arrow2x.svg" alt="" class="button-arrow">
                  </a>
                </div>
              </div>
            </div>
        ...
        <div id="w-node-_57edb05e-5748-d0c8-058b-77e80cc89305-3f3fd67e">
          <div>
            <div class="size5-text size5-top-clear">Luma Store<br></div>
            <p class="paragraph-70">Looking for a way to make your outdoor and indoor spaces shine this summer? From ceilings draped in LED lights to shimmering outdoor patios, here are eight illuminating ways to dress up your home with lighting.<br></p>
          </div>
          ...
          <div>
            <div class="product5-nav-items-wrap">
              ...
              <div class="product5-nav-lists">
                <a href="#" class="product5-category-link product5-all-items">Home</a>
                <a href="#" class="product5-category-link product5-all-items">Office</a>
                <a href="#" class="product5-category-link product5-all-items">Campus</a>
                <a href="#" class="product5-category-link product5-all-items">Bedroom</a>
                <a href="#" class="product5-category-link product5-all-items">Light Trends</a>
              </div>
            </div>
          </div>
          <div class="blog1-divider"></div>
          <div>
            <div class="product5-nav-items-wrap">
              ...
              <div class="product5-nav-lists">
                <a href="#" class="product5-category-link product5-all-items">Calvin Holmes</a>
                <a href="#" class="product5-category-link product5-all-items">Ellen Webb</a>
                <a href="#" class="product5-category-link product5-all-items">Ivan Daniel</a>
                <a href="#" class="product5-category-link product5-all-items">Daisy Bradley</a>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="wrapper m50-100">
    <div class="section">
      <div class="w-layout-grid cta8-grid">
        <div id="w-node-_7e01258a-3383-6ac7-1470-ad2f36ef57ac-36ef57a9" class="cta8-content-wrap">
        ...
        <div id="w-node-_7e01258a-3383-6ac7-1470-ad2f36ef57b4-36ef57a9" class="cta8-form w-form">
          <form id="email-form" name="email-form" data-name="Email Form" class="cta8-form-wrap w-node-_7e01258a-3383-6ac7-1470-ad2f36ef57b5-36ef57a9"><input type="email" class="text-field w-node-_7e01258a-3383-6ac7-1470-ad2f36ef57b6-36ef57a9 w-input" maxlength="256" name="email-2" data-name="Email 2" placeholder="Enter your email" id="email-2" required=""><input type="email" class="text-field w-node-_7e01258a-3383-6ac7-1470-ad2f36ef57b7-36ef57a9 w-input" maxlength="256" name="email-2" data-name="Email 2" placeholder="Enter your number" id="email-2" required=""><input type="email" class="text-field w-node-_7e01258a-3383-6ac7-1470-ad2f36ef57b8-36ef57a9 w-input" maxlength="256" name="email-2" data-name="Email 2" placeholder="Enter your email" id="email-2" required=""><input type="submit" value="Submit" data-wait="Please wait..." id="w-node-_7e01258a-3383-6ac7-1470-ad2f36ef57b9-36ef57a9" class="button-small form-centered-button w-button"></form>
      ...
      <div class="section">
        <div class="w-layout-grid footer1-grid"><img src="images/Luma-Logo.svg" id="w-node-ad9fe897-5290-7c85-17ea-ecb6e10ff8ce-c739f7eb" alt="" class="image">
          <div id="w-node-_2d8a3600-59cf-08d2-fe17-bd16c739f7f1-c739f7eb" class="footer1-links-wrap">
            ...
            <a href="blog.jsp" aria-current="page" class="footer1-link w--current">Blog</a>
