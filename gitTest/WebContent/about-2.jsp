...
<body>
  ...
  <div class="wrapper m0-100">
    <div class="content10-image"></div>
    <div class="content10-content-wrap">
      <div class="section">
        <div class="content10-bottom-section">
          <div class="w-layout-grid content10-grid">
            <div id="w-node-_209593d6-7cfc-28ad-62dd-2a0640dbbe7d-693fd67c">
              <div class="label">About Our Company</div>
              <div class="size1-text">&quot;The Bola Sphere Pendant is the basic foundation for the Bola Collection, featuring an elemental interplay between post and sphere.&quot;</div>
            </div>
            <div id="w-node-_209593d6-7cfc-28ad-62dd-2a0640dbbe82-693fd67c" class="content10-image2"></div>
            <div id="w-node-_209593d6-7cfc-28ad-62dd-2a0640dbbe83-693fd67c">
              <a data-w-id="209593d6-7cfc-28ad-62dd-2a0640dbbe84" href="#" class="button-large w-inline-block">
                <div>Read more about Our Mission</div><img src="images/Arrow2x.svg" alt="" class="button-arrow">
              </a>
            </div>
          </div>
        </div>
  ...
  <div class="wrapper m50-80">
    <div class="section">
      <div class="w-layout-grid content9-grid">
        <div id="w-node-ef4f19e6-f796-6f5a-e694-e9de91330130-693fd67c" class="content9-content-wrap">
          <div class="content9-text">
            <div class="size1-text size1-top-clear">Right light can transform any environment</div>
            <p class="paragraph-70">A common thread links all of its creations, valuing permanence and sustainability, discarding the disposable mindset so prevalent today. Its mission is to create designs that deepen the relationship between objects, their users, and their environments.</p>
          </div>
          <div class="deco-dot"></div>
        </div>
        <div id="w-node-ef4f19e6-f796-6f5a-e694-e9de91330137-693fd67c" class="w-layout-grid content9-image-grid">
          <div id="w-node-ef4f19e6-f796-6f5a-e694-e9de91330138-693fd67c" class="content9-grey-section"></div>
          <div id="w-node-ef4f19e6-f796-6f5a-e694-e9de91330139-693fd67c" class="content9-image1"></div>
          <div id="w-node-ef4f19e6-f796-6f5a-e694-e9de9133013a-693fd67c" class="content9-image2"></div>
        </div>
      </div>
    </div>
  </div>
  <div class="wrapper m50-100">
    <div class="section">
      <div class="w-layout-grid content36-grid">
        <div id="w-node-f3496c2c-8ee9-32b0-6803-75773ca743f3-693fd67c" class="content36-headline-wrap">
          <div class="text-label">People Behind the Lights</div>
          <div class="size3-text">Meet our team<br></div>
        </div>
        <div id="w-node-f3496c2c-8ee9-32b0-6803-75773ca743f9-693fd67c">
          <div class="content36-author-pic content36-pic1"></div>
          <div class="text-label">Designer</div>
          <div class="size4-text">Calvin Holmes<br></div>
          <p class="paragraph-70">The multidisciplinary designer specializes in furniture for the contract, hospitality and residential markets, as well as lighting.<br></p>
        </div>
        <div id="w-node-f3496c2c-8ee9-32b0-6803-75773ca74403-693fd67c">
          <div class="content36-author-pic content36-pic2"></div>
        ...
        <div id="w-node-f3496c2c-8ee9-32b0-6803-75773ca7440d-693fd67c">
          <div class="content36-author-pic content36-pic3"></div>
          <div class="text-label">Designer</div>
          <div class="size4-text">Ivan Daniel<br></div>
          <p class="paragraph-70">Interested in how the pragmatism of the traditional craftsman can create new design, he focuses on simplicity.<br></p>
        </div>
      </div>
    </div>
  </div>
  <div class="wrapper m20-100">
    <div class="section">
      <div class="w-layout-grid content16-grid">
        <div id="w-node-b2fb4585-c262-cfb0-fb76-8ccc82219188-693fd67c" class="content16-left-column">
