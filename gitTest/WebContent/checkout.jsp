...
<body>
  ...
  <div class="wrapper m80">
    <div class="section">
      <div class="w-layout-grid grid">
        <div id="w-node-_749fdd28-44d1-08ab-b7ea-c7a184ac80ab-de3fd67f" class="checkout-headline-wrap">
  ...
  <div class="wrapper m0-100">
    <div class="section">
      <div class="grid">
        <div id="w-node-_67c92ccb-f433-05ee-d873-2bf3bf5867ff-de3fd67f" data-node-type="commerce-checkout-form-container" data-wf-checkout-query="" data-wf-page-link-href-prefix="" class="w-commerce-commercecheckoutformcontainer checkout-form">
          <div class="w-commerce-commercelayoutcontainer checkout-container w-container">
            <div class="w-commerce-commercelayoutmain payment-details-wrap">
              ...
              <div data-node-type="commerce-cart-quick-checkout-actions" class="web-payments">
                ...
                <a data-node-type="commerce-cart-quick-checkout-button" style="display:none" class="w-commerce-commercecartquickcheckoutbutton web-payment-button"><svg class="w-commerce-commercequickcheckoutgoogleicon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="16" height="16" viewbox="0 0 16 16">
                    <defs>
                      <polygon id="google-mark-a" points="0 .329 3.494 .329 3.494 7.649 0 7.649"></polygon>
                      <polygon id="google-mark-c" points=".894 0 13.169 0 13.169 6.443 .894 6.443"></polygon>
                    </defs>
              ...
              <form data-node-type="commerce-checkout-customer-info-wrapper" class="w-commerce-commercecheckoutcustomerinfowrapper">
                <div class="w-commerce-commercecheckoutblockheader block-header">
                  <h4 class="checkout-section-headline">Customer Info</h4>
                  <div class="paragraph-small">* Required</div>
                </div>
                <fieldset class="w-commerce-commercecheckoutblockcontent"><label class="w-commerce-commercecheckoutlabel text-label">Email *</label><input type="text" name="email" required="" class="w-commerce-commercecheckoutemailinput text-field"></fieldset>
              </form>
              <form data-node-type="commerce-checkout-shipping-address-wrapper" class="w-commerce-commercecheckoutshippingaddresswrapper">
                <div class="w-commerce-commercecheckoutblockheader block-header">
                  <h4 class="checkout-section-headline">Shipping Address</h4>
                  <div class="paragraph-small">* Required</div>
                </div>
                <fieldset class="w-commerce-commercecheckoutblockcontent"><label class="w-commerce-commercecheckoutlabel text-label">Full Name *</label><input type="text" name="name" required="" class="w-commerce-commercecheckoutshippingfullname text-field bottom-margin-field"><label class="w-commerce-commercecheckoutlabel text-label">Street Address *</label><input type="text" name="address_line1" required="" class="w-commerce-commercecheckoutshippingstreetaddress text-field bottom-margin-field"><input type="text" name="address_line2" class="w-commerce-commercecheckoutshippingstreetaddressoptional text-field bottom-margin-field">
                  <div class="w-commerce-commercecheckoutrow">
                    <div class="w-commerce-commercecheckoutcolumn"><label class="w-commerce-commercecheckoutlabel text-label">City *</label><input type="text" name="address_city" required="" class="w-commerce-commercecheckoutshippingcity text-field bottom-margin-field"></div>
                    <div class="w-commerce-commercecheckoutcolumn"><label class="w-commerce-commercecheckoutlabel text-label">State/Province</label><input type="text" name="address_state" class="w-commerce-commercecheckoutshippingstateprovince text-field bottom-margin-field"></div>
                    <div class="w-commerce-commercecheckoutcolumn"><label class="w-commerce-commercecheckoutlabel text-label">Zip/Postal Code *</label><input type="text" name="address_zip" required="" data-node-type="commerce-checkout-shipping-zip-field" class="w-commerce-commercecheckoutshippingzippostalcode text-field bottom-margin-field"></div>
                  </div><label class="w-commerce-commercecheckoutlabel text-label">Country *</label><select name="address_country" class="w-commerce-commercecheckoutshippingcountryselector">
              ...
              <div class="w-commerce-commercecheckoutpaymentinfowrapper">
                ...
                <fieldset class="w-commerce-commercecheckoutblockcontent"><label class="w-commerce-commercecheckoutlabel text-label">Card Number *</label>
                  <div data-wf-stripe-element-type="cardNumber" data-wf-style-map="{&quot;main&quot;:{&quot;noPseudo&quot;:{&quot;color&quot;:&quot;hsla(240, 9.43%, 10.39%, 1.00)&quot;,&quot;fontSize&quot;:&quot;14px&quot;,&quot;textTransform&quot;:&quot;none&quot;},&quot;focus&quot;:{&quot;color&quot;:&quot;hsla(240, 9.43%, 10.39%, 1.00)&quot;},&quot;placeholder&quot;:{&quot;color&quot;:&quot;rgba(153, 153, 153, 1)&quot;}},&quot;tiny&quot;:{&quot;noPseudo&quot;:{&quot;fontSize&quot;:&quot;16px&quot;}}}" style="position:relative" class="w-commerce-commercecheckoutcardnumber text-field bottom-margin-field">
                    <div></div>
                    <div style="position:absolute;top:0;left:0;width:100%;height:100%;opacity:0"></div>
                  </div>
                  <div class="w-commerce-commercecheckoutrow">
                    <div class="w-commerce-commercecheckoutcolumn"><label class="w-commerce-commercecheckoutlabel text-label">Expiration Date *</label>
                      <div data-wf-stripe-element-type="cardExpiry" data-wf-style-map="{&quot;main&quot;:{&quot;noPseudo&quot;:{&quot;color&quot;:&quot;hsla(240, 9.43%, 10.39%, 1.00)&quot;,&quot;fontSize&quot;:&quot;14px&quot;,&quot;textTransform&quot;:&quot;none&quot;},&quot;focus&quot;:{&quot;color&quot;:&quot;hsla(240, 9.43%, 10.39%, 1.00)&quot;},&quot;placeholder&quot;:{&quot;color&quot;:&quot;rgba(153, 153, 153, 1)&quot;}},&quot;tiny&quot;:{&quot;noPseudo&quot;:{&quot;fontSize&quot;:&quot;16px&quot;}}}" style="position:relative" class="w-commerce-commercecheckoutcardexpirationdate text-field bottom-margin-field">
                        <div></div>
                        <div style="position:absolute;top:0;left:0;width:100%;height:100%;opacity:0"></div>
                      </div>
                    </div>
                    <div class="w-commerce-commercecheckoutcolumn"><label class="w-commerce-commercecheckoutlabel text-label">Security Code *</label>
                      <div data-wf-stripe-element-type="cardCvc" data-wf-style-map="{&quot;main&quot;:{&quot;noPseudo&quot;:{&quot;color&quot;:&quot;hsla(240, 9.43%, 10.39%, 1.00)&quot;,&quot;fontSize&quot;:&quot;14px&quot;,&quot;textTransform&quot;:&quot;none&quot;},&quot;focus&quot;:{&quot;color&quot;:&quot;hsla(240, 9.43%, 10.39%, 1.00)&quot;},&quot;placeholder&quot;:{&quot;color&quot;:&quot;rgba(153, 153, 153, 1)&quot;}},&quot;tiny&quot;:{&quot;noPseudo&quot;:{&quot;fontSize&quot;:&quot;16px&quot;}}}" style="position:relative" class="w-commerce-commercecheckoutcardsecuritycode text-field bottom-margin-field">
                        <div></div>
                        <div style="position:absolute;top:0;left:0;width:100%;height:100%;opacity:0"></div>
                      </div>
                    </div>
              ...
              <form data-node-type="commerce-checkout-billing-address-wrapper" style="display:none" class="w-commerce-commercecheckoutbillingaddresswrapper">
                <div class="w-commerce-commercecheckoutblockheader block-header">
                  <h4 class="checkout-section-headline">Billing Address</h4>
                  <div class="paragraph-small">* Required</div>
                </div>
                <fieldset class="w-commerce-commercecheckoutblockcontent"><label class="w-commerce-commercecheckoutlabel text-label">Full Name *</label><input type="text" name="name" required="" class="w-commerce-commercecheckoutbillingfullname text-field bottom-margin-field"><label class="w-commerce-commercecheckoutlabel text-label">Street Address *</label><input type="text" name="address_line1" required="" class="w-commerce-commercecheckoutbillingstreetaddress text-field bottom-margin-field"><input type="text" name="address_line2" class="w-commerce-commercecheckoutbillingstreetaddressoptional text-field bottom-margin-field">
                  <div class="w-commerce-commercecheckoutrow">
                    <div class="w-commerce-commercecheckoutcolumn"><label class="w-commerce-commercecheckoutlabel text-label">City *</label><input type="text" name="address_city" required="" class="w-commerce-commercecheckoutbillingcity text-field bottom-margin-field"></div>
                    <div class="w-commerce-commercecheckoutcolumn"><label class="w-commerce-commercecheckoutlabel text-label">State/Province</label><input type="text" name="address_state" class="w-commerce-commercecheckoutbillingstateprovince text-field bottom-margin-field"></div>
                    <div class="w-commerce-commercecheckoutcolumn"><label class="w-commerce-commercecheckoutlabel text-label">Zip/Postal Code *</label><input type="text" name="address_zip" required="" data-node-type="commerce-checkout-billing-zip-field" class="w-commerce-commercecheckoutbillingzippostalcode text-field bottom-margin-field"></div>
                  </div><label class="w-commerce-commercecheckoutlabel text-label">Country *</label><select name="address_country" class="w-commerce-commercecheckoutshippingcountryselector">
                    <option value="AF">Afghanistan</option>
                    <option value="AX">Aland Islands</option>
                    <option value="AL">Albania</option>
              ...
              <div class="w-commerce-commercecheckoutorderitemswrapper">
                ...
                <fieldset class="w-commerce-commercecheckoutblockcontent">
                  <script type="text/x-wf-template" id="wf-template-67c92ccb-f433-05ee-d873-2bf3bf586878"></script>
                  <div class="w-commerce-commercecheckoutorderitemslist" data-wf-collection="database.commerceOrder.userItems" data-wf-template-id="wf-template-67c92ccb-f433-05ee-d873-2bf3bf586878"></div>
                </fieldset>
              </div>
            </div>
            <div class="w-commerce-commercelayoutsidebar order-summary-wrap">
              <div class="w-commerce-commercecheckoutordersummarywrapper">
                ...
                <fieldset class="w-commerce-commercecheckoutblockcontent">
                  ...
                  <script type="text/x-wf-template" id="wf-template-67c92ccb-f433-05ee-d873-2bf3bf586892">%3Cdiv%20class%3D%22w-commerce-commercecheckoutordersummaryextraitemslistitem%22%3E%3Cdiv%20class%3D%22paragraph-70%20paragraph70-bottom-clear%22%3E%3C%2Fdiv%3E%3Cdiv%3E%3C%2Fdiv%3E%3C%2Fdiv%3E</script>
                  <div class="w-commerce-commercecheckoutordersummaryextraitemslist" data-wf-collection="database.commerceOrder.extraItems" data-wf-template-id="wf-template-67c92ccb-f433-05ee-d873-2bf3bf586892">
                    <div class="w-commerce-commercecheckoutordersummaryextraitemslistitem">
                      <div class="paragraph-70 paragraph70-bottom-clear"></div>
                      <div></div>
                    </div>
                  </div>
                  <div class="w-commerce-commercecheckoutsummarylineitem total-line-item">
                    <div>Total</div>
              ...
              <div data-node-type="commerce-checkout-error-state" style="display:none" class="w-commerce-commercecheckouterrorstate error-message">
