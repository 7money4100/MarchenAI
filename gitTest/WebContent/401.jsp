...
<body class="grey-body">
  <div class="utility-page-wrap">
    <div class="utility-page-content w-password-page w-form">
      <form action="/.wf_auth" method="post" class="utility-page-form w-password-page">
        <div>
          <h1 class="size1-text size1-top-clear">Protected Page</h1>
        </div>
        <div class="utility-page-form-wrap"><input type="password" autofocus="true" maxlength="256" name="pass" placeholder="Enter your password" class="text-field bottom-margin-field w-password-page w-input"><input type="submit" value="Submit" data-wait="Please wait..." class="button-small w-password-page w-button"></div>
        <div class="error-message w-password-page w-form-fail">
