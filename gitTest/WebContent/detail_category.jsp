    ...
    <div class="category-detail-wrap">
      <div class="section">
        <div class="w-layout-grid grid">
          <h1 id="w-node-de65fc6f-268e-621a-c6a4-4b04a9a1060d-353fd682" class="sizejumbo-text sizejumbo-full-clear"></h1>
        </div>
      </div>
    </div>
  </div>
  <div class="wrapper m100-0">
    <div class="section">
      <div class="w-layout-grid content32-grid">
        <div id="w-node-_5ffc866d-8b94-a049-0299-35b9c2252c84-353fd682" class="content32-quote"></div>
        <div id="w-node-_5ffc866d-8b94-a049-0299-35b9c2252c86-353fd682" class="content32-image"></div>
      </div>
    </div>
  </div>
  <div class="wrapper m100">
    <div class="section">
      <div class="w-layout-grid product5-grid">
        <div id="w-node-aa28b032-2c39-a4bf-6f2c-ffbebce3a258-353fd682" class="product5-nav-wrap">
          <div class="product5-nav-items-wrap">
            <div class="text-label">Categories</div>
            <div class="product5-nav-lists">
              <a href="#" class="product5-category-link product5-all-items">All Items</a>
        ...
        <div id="w-node-aa28b032-2c39-a4bf-6f2c-ffbebce3a271-353fd682" class="w-dyn-list">
          <div role="list" class="product5-feed-grid w-dyn-items">
            <div id="w-node-aa28b032-2c39-a4bf-6f2c-ffbebce3a273-353fd682" role="listitem" class="w-dyn-item">
              <div class="image-wrap">
                <a data-w-id="aa28b032-2c39-a4bf-6f2c-ffbebce3a275" style="opacity:0" href="#" class="item-overlay w-inline-block">
    ...
    <div>
      <div class="section">
        <div class="w-layout-grid content35-top-grid">
          <div id="w-node-ba4d92c8-c9c9-43d5-b5a3-613bca5ac048-353fd682" class="content35-headline-wrap">
            <div class="content35-section-headline">
              <div class="size1-text size1-top-clear">Let¡¯s get social!<br></div>
            ...
            <a data-w-id="ba4d92c8-c9c9-43d5-b5a3-613bca5ac04e" href="#" class="button-small w-inline-block">
      ...
      <div class="section">
        <div class="content35-bottom-grid">
          <div id="w-node-ba4d92c8-c9c9-43d5-b5a3-613bca5ac05b-353fd682">
            <div class="size5-text">Free Shipping</div>
            <div class="content35-item-label">within USA</div>
          </div>
          <div id="w-node-ba4d92c8-c9c9-43d5-b5a3-613bca5ac060-353fd682">
            <div class="size5-text">Easy Returns</div>
            <div class="content35-item-label">within 7 days</div>
          </div>
          <div id="w-node-ba4d92c8-c9c9-43d5-b5a3-613bca5ac065-353fd682">
            <div class="size5-text">1 year Warranty</div>
            <div class="content35-item-label">ON ALL LAMPS</div>
          </div>
        </div>
      </div>
    </div>
