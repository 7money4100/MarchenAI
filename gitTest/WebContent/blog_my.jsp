...
<%
   ...
   bAllList = dao.myAllSelect(member_id);
   bSelectList = dao.mySelect(input_search, member_id);
...
<!--? Preloader Start -->
    ...
    <main>
        <!--? Hero Area Start-->
        <div><img src="assets/img/hero/my.png" style="width:100%"></div>
        <!--? Hero Area End-->
        <!--================Blog Area =================-->
                                   ...
                                   <div class="blog_item_img">
                                         <form action="BlogDeleteService" id="blogDeleteService<%=i%>" style="float :right">
                                           <div class="favorit-items">
                                               ...
                                               <input name="filename" value="<%=bAllList.get(i).getFilename()%>" style="display:none">
                                           </div>
                                        </form>
